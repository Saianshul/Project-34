...
function setup() {
	...
	pendulum1 = new Pendulum(340, 450, 60);
	pendulum2 = new Pendulum(400, 450, 60);
	pendulum3 = new Pendulum(460, 450, 60);
	pendulum4 = new Pendulum(520, 450, 60);
	pendulum5 = new Pendulum(580, 450, 60);
